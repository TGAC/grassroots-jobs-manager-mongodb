 ...
 * @file
 */
#ifndef MONGODB_JOBS_MANAGER_LIBRARY_H
#define MONGODB_JOBS_MANAGER_LIBRARY_H
...
*/
  ...
  #define MONGODB_JOBS_MANAGER_LOCAL LIB_HELPER_SYMBOL_LOCAL
#else /* SHARED_LIBRARY is not defined: this means LIB is a static lib. */
  #define MONGODB_JOBS_MANAGER_API
  #define MONGODB_JOBS_MANAGER_LOCAL
#endif /* #ifdef SHARED_LIBRARY */


#endif		/* #ifndef MONGODB_JOBS_MANAGER_LIBRARY_H */
